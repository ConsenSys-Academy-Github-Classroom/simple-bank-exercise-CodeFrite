...
contract SimpleBank {
    ...
    /// @notice Get enrolled
    function getEnrolled(address _address) public view returns (bool) {
      return enrolled[_address];
    }
    ...
    function deposit() public payable returns (uint) {
      ...
      require(enrolled[msg.sender],"Error: User should be enrolled before they can make deposits");
    ...
    function withdraw(uint withdrawAmount) public payable returns (uint) {
      ...
      require(balances[msg.sender]>=withdrawAmount,"Error: User balance should be at least equal to the withdraw amount");
